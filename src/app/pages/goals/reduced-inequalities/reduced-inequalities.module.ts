...
import { BulletPointsOnTwoSectionsDefaultTwoComponent } from 'src/app/components/goals/bullet-points-on-two-sections-default-two/bullet-points-on-two-sections-default-two.component';
...
@NgModule({
  ...
  declarations: [ReducedInequalitiesPage,
    ...
    BulletPointsOnTwoSectionsDefaultTwoComponent,
  ]
